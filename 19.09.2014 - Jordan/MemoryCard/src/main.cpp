...
//	gScratchMusicGame = Mix_LoadMUS("sounds/cautious-path-01.mp3");
	...
	gSpriteButtonSound[0].w = 100;
	gSpriteButtonSound[0].h = 100;

	gSpriteButtonSound[1].x = 100;
	gSpriteButtonSound[1].y = 0;
	gSpriteButtonSound[1].w = 100;
	gSpriteButtonSound[1].h = 100;
	...
	gSpriteButtonSoundPosition[0].w = 100;
	gSpriteButtonSoundPosition[0].h = 100;
